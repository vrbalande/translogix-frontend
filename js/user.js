...
/*
   ...
   IMPORTANT:
   Do NOT fallback to /api/shipments.
   Customer must only receive shipments assigned
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    function createShipmentCard(item) {
        ...
        return `
            ...
            <article class="user-shipment-card">

                <div class="user-shipment-head">
                ...
                <button
                    ...
                    data-user-open-id="${escapeHTML(item.id)}"
                >
                    Open Shipment →
                </button>
    ...
    async function loadShipments() {
        ...
        try {
            ...
            /*
             * IMPORTANT:
             * Only use the authenticated user endpoint.
             *
             * Do NOT call /api/shipments here.
             */
            ...
            console.error(
                "TRANSLOGIX USER SHIPMENT API ERROR:",
                error
            );
